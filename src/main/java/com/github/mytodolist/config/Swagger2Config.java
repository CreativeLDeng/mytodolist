package com.github.mytodolist.config;
...
public class Swagger2Config {
    ...
    private final static String NAME = "liu";
    private final static String URL = "暂无";
    private final static String EMAIL	= "dengliu-email@foxmail.com";
    ...
    public Docket restApiDocket() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.github.mytodolist.controller")) // 指定扫描的包路径
